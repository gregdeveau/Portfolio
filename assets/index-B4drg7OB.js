(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`gregdeveau`,t={name:`Greg Deveau`,role:`Systems and Infrastructure Focused IT Professional`,headline:`I am most at home working with systems, networking, Docker, and the kind of troubleshooting that keeps things running.`,intro:`Most of my experience is on the systems and IT side: Linux, networking, Docker, support work, and figuring out why something broke. A good example is the Linux home lab I built around containers, storage, monitoring, and secure remote access. This portfolio is my way of putting that in one place while still meeting the assignment requirements with live GitHub data and interactive UI.`,about:`I like the part of tech where servers, networks, and applications all meet. I have spent more time around Linux, Windows Server coursework, reverse proxies, self-hosting, and hands-on support than building public apps, and I wanted this portfolio to reflect that honestly.`,goals:`I am aiming for roles where I can keep growing in systems, infrastructure, automation, and eventually more development work too. Right now I am focused on getting stronger with scripting and full-stack concepts without losing the operations background that fits me best.`},n=[{title:`Systems & Infrastructure`,copy:`These are the big platform and environment skills I would want an employer to notice first.`,items:[`Linux`,`Docker`,`Windows Server`,`Nginx / Reverse Proxy`]},{title:`Networking & Security`,copy:`These are the networking and security fundamentals I am most comfortable talking about.`,items:[`TCP/IP & DNS`,`VLANs`,`Firewalls`,`SSL/TLS`]},{title:`Operations & Automation`,copy:`These are the day-to-day skills that connect support work, scripting, and keeping things moving.`,items:[`Technical Support`,`Incident Management`,`PowerShell`,`Git`]}],r=[{id:`systems-labs`,title:`Systems Labs and Admin Practice`,category:`systems`,summary:`A lot of my hands-on experience comes from labs and coursework around Linux, Windows Server, remote administration, and learning how systems fit together.`,challenge:`The hard part was not just learning each tool on its own, but learning how the whole environment connects.`,outcome:`It gave me a much better feel for troubleshooting, configuration, and thinking through systems problems calmly.`,tech:[`Linux`,`Windows Server`,`RDP / SSH`,`Systems Administration`],highlights:[`Worked in both Linux and Windows-oriented environments.`,`Built confidence with access, setup, and troubleshooting tasks.`,`Started thinking more like someone responsible for the whole environment, not just one app.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`},{id:`homelab`,title:`Self-Hosted Linux Home Lab`,category:`docker`,summary:`I built a Linux-based home lab around Docker containers, media services, monitoring, secure remote access, and a storage layout designed to fit my own needs.`,challenge:`The hard part was building something flexible and useful without leaning on a paid platform, while still keeping storage, monitoring, and remote access manageable.`,outcome:`It gave me real hands-on experience with self-hosting, containerized services, observability, storage design, and safer remote access decisions.`,tech:[`Docker`,`mergerFS`,`Grafana`,`WireGuard`],highlights:[`Runs Plex, Sonarr, Radarr, Grafana, and Prometheus in Docker.`,`Uses a 12 TB NAS drive, a cache drive, and mergerFS to present storage as one logical volume.`,`Uses Tailscale, WireGuard, and UFW, with only the WireGuard port forwarded instead of exposing web UIs directly.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`},{id:`networking-practice`,title:`Networking and Troubleshooting Practice`,category:`networking`,summary:`This is the side of my background focused on core networking ideas like TCP/IP, DNS, VLANs, and firewalls.`,challenge:`The goal was turning theory into something practical enough to troubleshoot and explain clearly.`,outcome:`I came away with a better grasp of the networking basics that show up constantly in infrastructure and support work.`,tech:[`TCP/IP`,`DNS`,`VLANs`,`Firewalls`],highlights:[`Worked through the practical side of network setup and diagnosis.`,`Got more comfortable with layered troubleshooting instead of guessing.`,`Built a better understanding of how much everything else depends on the network working properly.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`},{id:`support-automation`,title:`IT Support and Automation`,category:`support`,summary:`A lot of my practical experience comes from support work, ticketing, and the habits that keep users and systems moving.`,challenge:`The balancing act here is solving problems quickly while still building deeper technical skills over time.`,outcome:`It gave me a solid base for roles that sit somewhere between support, systems work, and infrastructure.`,tech:[`Technical Support`,`Incident Management`,`PowerShell`,`PostgreSQL`],highlights:[`Worked with ticketing and incident-driven support workflows.`,`Used PowerShell, Git, and coursework scripting to build better automation habits.`,`Kept building toward roles that mix support, systems, and technical growth.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`}],i=[{value:`all`,label:`All`},{value:`systems`,label:`Systems`},{value:`networking`,label:`Networking`},{value:`docker`,label:`Docker / Home Lab`},{value:`support`,label:`Support`}],a=[{title:`GitHub`,value:`github.com/gregdeveau`,note:`Browse public repositories and course work.`,href:`https://github.com/gregdeveau`},{title:`Portfolio Repository`,value:`github.com/gregdeveau/Portfolio`,note:`This portfolio is built and deployed from the same repository, even though my public project history is still pretty small right now.`,href:`https://github.com/gregdeveau/Portfolio`},{title:`Public Contact`,value:`Add your preferred public email or LinkedIn before final submission.`,note:`Keep public contact details professional and safe to publish.`,href:``}],o={search:``,filter:`all`,theme:s(),repos:[],githubStatus:`idle`,githubMessage:`This section pulls in live GitHub data, even though my public repo history is still pretty small right now.`,activeProjectId:null};function s(){try{let e=window.localStorage.getItem(`portfolio-theme`);if(e===`studio`||e===`midnight`)return e}catch{}return window.matchMedia(`(prefers-color-scheme: dark)`).matches?`midnight`:`studio`}function c(e){o.theme=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(`portfolio-theme`,e)}catch{}let t=document.getElementById(`theme-toggle`);t&&(t.textContent=e===`studio`?`Switch to Night`:`Switch to Day`)}function l(){return n.reduce((e,t)=>e+t.items.length,0)}function u(){document.getElementById(`app`).innerHTML=`
