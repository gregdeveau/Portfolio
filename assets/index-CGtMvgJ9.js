(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`gregdeveau`,t={name:`Greg Deveau`,role:`Systems and Infrastructure IT`,headline:`I like working with systems, networking, Docker, and the kind of troubleshooting that keeps things running.`,intro:`Most of my background is on the systems and IT side: Linux, networking, Docker, support work, and figuring out why something broke. A good example is the Linux home lab I built around containers, storage, monitoring, and secure remote access. This portfolio pulls that together in one place while still using live GitHub data and some simple interactivity.`,about:`I like the part of tech where servers, networks, and applications all meet. I have spent more time around Linux, Windows Server coursework, reverse proxies, self-hosting, and hands-on support than building public apps, so I wanted the portfolio to reflect that honestly.`,goals:`I want to keep growing in systems, infrastructure, automation, and development. Right now that means getting better with scripting and full-stack concepts without losing the operations background that fits me best.`},n=[{title:`Systems & Infrastructure`,copy:`These are the main platform skills I would want an employer to notice first.`,items:[`Linux`,`Docker`,`Windows Server`,`Nginx / Reverse Proxy`]},{title:`Networking & Security`,copy:`These are the networking and security basics I am most comfortable with.`,items:[`TCP/IP & DNS`,`VLANs`,`Firewalls`,`SSL/TLS`]},{title:`Operations & Automation`,copy:`These are the day-to-day skills that connect support work, scripting, and keeping things moving.`,items:[`Technical Support`,`Incident Management`,`PowerShell`,`Git`]}],r=[{id:`systems-labs`,title:`Systems Labs and Admin Practice`,category:`systems`,summary:`A lot of my hands-on experience comes from labs and coursework around Linux, Windows Server, remote administration, and learning how systems fit together.`,challenge:`The hard part was learning how the whole environment connects, not just each tool on its own.`,outcome:`It gave me a better feel for troubleshooting, configuration, and thinking through systems problems calmly.`,tech:[`Linux`,`Windows Server`,`RDP / SSH`,`Systems Administration`],highlights:[`Worked in both Linux and Windows-oriented environments.`,`Built confidence with access, setup, and troubleshooting tasks.`,`Started thinking more like someone responsible for the whole environment, not just one app.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`},{id:`homelab`,title:`Self-Hosted Linux Home Lab`,category:`docker`,summary:`I built a Linux home lab around Docker containers, media services, monitoring, secure remote access, and a storage layout that fits what I actually use.`,challenge:`The hard part was building something flexible and useful without relying on a paid platform, while still keeping storage, monitoring, and remote access manageable.`,outcome:`It gave me real hands-on experience with self-hosting, containers, monitoring, storage design, and safer remote access decisions.`,tech:[`Docker`,`mergerFS`,`Grafana`,`WireGuard`],highlights:[`Runs Plex, Sonarr, Radarr, Grafana, and Prometheus in Docker.`,`Uses a 12 TB NAS drive, a cache drive, and mergerFS to present storage as one logical volume.`,`Uses Tailscale, WireGuard, and UFW, with only the WireGuard port forwarded instead of exposing web UIs directly.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`},{id:`networking-practice`,title:`Networking and Troubleshooting Practice`,category:`networking`,summary:`This side of my background is focused on core networking ideas like TCP/IP, DNS, VLANs, and firewalls.`,challenge:`The goal was turning theory into something practical enough to troubleshoot and explain clearly.`,outcome:`I came away with a better grasp of the networking basics that show up all the time in infrastructure and support work.`,tech:[`TCP/IP`,`DNS`,`VLANs`,`Firewalls`],highlights:[`Worked through the practical side of network setup and diagnosis.`,`Got more comfortable with layered troubleshooting instead of guessing.`,`Built a better understanding of how much everything else depends on the network working properly.`],link:`https://github.com/gregdeveau`,label:`GitHub Profile`},{id:`piratesway-bjj`,title:`Piratesway BJJ Website`,category:`web`,summary:`I built the website for Piratesway Jiu-Jitsu with a focus on being clear, welcoming, and easy for new people to use.`,challenge:`The main goal was keeping it simple and mobile-friendly so someone with zero experience could understand the gym and book a class.`,outcome:`It gave me real experience building for an actual business with a focus on usability, accessibility, and clear calls to action.`,tech:[`HTML`,`CSS`,`JavaScript`,`Cloudflare Pages`],highlights:[`Built for a real local business instead of just a class exercise.`,`Focused on mobile-first design, beginner-friendly content, and strong calls to action.`,`Considered accessibility and local SEO so the site is useful as well as polished.`],link:`https://www.pirateswaybjj.com`,label:`Live Site`}],i=[{value:`all`,label:`All`},{value:`systems`,label:`Systems`},{value:`networking`,label:`Networking`},{value:`docker`,label:`Docker / Home Lab`},{value:`web`,label:`Website`}],a=[{title:`GitHub`,value:`github.com/gregdeveau`,note:`Browse public repositories and course work.`,href:`https://github.com/gregdeveau`},{title:`Portfolio Repository`,value:`github.com/gregdeveau/Portfolio`,note:`This portfolio is built and deployed from the same repository, even though my public project history is still small right now.`,href:`https://github.com/gregdeveau/Portfolio`},{title:`Public Contact`,value:`Add your preferred public email or LinkedIn before final submission.`,note:`Keep public contact details professional and safe to publish.`,href:``}],o={search:``,filter:`all`,theme:s(),repos:[],githubStatus:`idle`,githubMessage:`This section pulls in live GitHub data, even though my public repo history is still small right now.`,activeProjectId:null};function s(){try{let e=window.localStorage.getItem(`portfolio-theme`);if(e===`studio`||e===`midnight`)return e}catch{}return window.matchMedia(`(prefers-color-scheme: dark)`).matches?`midnight`:`studio`}function c(e){o.theme=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(`portfolio-theme`,e)}catch{}let t=document.getElementById(`theme-toggle`);t&&(t.textContent=e===`studio`?`Switch to Night`:`Switch to Day`)}function l(){return n.reduce((e,t)=>e+t.items.length,0)}function u(){document.getElementById(`app`).innerHTML=`
